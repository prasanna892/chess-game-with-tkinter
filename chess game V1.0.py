...
def inp():
        ...
        if val=='f':
            ...
            if b==True:
                if checking_for_checkb():
                    if bc:
                        bc = False
                        Thread(target = speak("player one put check on player two")).start()
                else:
                    bc = True
                player_turn=2
                # soilder move
    ...
    ######################################################################
                ...
                if checking_for_checkw():
                    if wc:
                        wc = False
                        Thread(target = speak("player two put check on player one")).start()
                else:
                    wc = True
...
def chess_board():
    ...
    root = Tk()
    root.title('chess game with python   CREADTED BY: PRASANNA.K')
   ...
   ## score frame
    create=Label(frame2,text='player 1\nyour\nturn',fg="black",font=('Algerian',15),bg="yellow",width=8,anchor= CENTER)
    create.grid(row=0,column=0)

    p1=Label(frame2,text='player1\nscore',fg="red",font=('Algerian',15),bg="blue",width=8,anchor= CENTER)
    p1.grid(row=1,column=0)

    sw=Label(frame2,text='♟X0=0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    sw.grid(row=2,column=0)

    hw=Label(frame2,text='♞X0=0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    hw.grid(row=3,column=0)

    bw=Label(frame2,text='♝X0=0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    bw.grid(row=4,column=0)

    rw=Label(frame2,text='♜X0=0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    rw.grid(row=5,column=0)

    qw=Label(frame2,text='♚X0=0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    qw.grid(row=6,column=0)

    tw=Label(frame2,text='total:0',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    tw.grid(row=7,column=0)


    p2=Label(frame2,text='player2\nscore',fg="blue",font=('Algerian',15),bg="orange",width=8,anchor= CENTER)
    p2.grid(row=8,column=0)

    sb=Label(frame2,text='♙X0=0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    sb.grid(row=9,column=0)

    hb=Label(frame2,text='♘X0=0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    hb.grid(row=10,column=0)

    bb=Label(frame2,text='♗X0=0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    bb.grid(row=11,column=0)

    rb=Label(frame2,text='♖X0=0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    rb.grid(row=12,column=0)

    qb=Label(frame2,text='♔X0=0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    qb.grid(row=13,column=0)

    tb=Label(frame2,text='total:0',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
    ...
    def help_():
        ...
        #split=Label(frame3,text='✿✿✿✿\n✿✿✿✿',fg="purple",font=('Algerian',15),bg="yellow",width=8,anchor= CENTER)
        #split.grid(row=0,column=0)

        hp1=Label(frame3,text='player1\ncoin',fg="red",font=('Algerian',15),bg="blue",width=8,anchor= CENTER)
        hp1.grid(row=1,column=0)

        hsw=Label(frame3,text='♙-Pawn',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hsw.grid(row=2,column=0)

        hhw=Label(frame3,text='♘-Knight',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hhw.grid(row=3,column=0)

        hbw=Label(frame3,text='♗-Bishop',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hbw.grid(row=4,column=0)

        hrw=Label(frame3,text='♖-Rook',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hrw.grid(row=5,column=0)

        hqw=Label(frame3,text='♔-Queen',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hqw.grid(row=6,column=0)

        hkw=Label(frame3,text='♕-King',fg=uppercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hkw.grid(row=7,column=0)

        hp2=Label(frame3,text='player2\ncoin',fg="blue",font=('Algerian',15),bg="orange",width=8,anchor= CENTER)
        hp2.grid(row=8,column=0)

        hsb=Label(frame3,text='♟-Pawn',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hsb.grid(row=9,column=0)

        hhb=Label(frame3,text='♞-Knight',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hhb.grid(row=10,column=0)

        hbb=Label(frame3,text='♝-Bishop',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hbb.grid(row=11,column=0)

        hrb=Label(frame3,text='♜-Rook',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hrb.grid(row=12,column=0)

        hqb=Label(frame3,text='♚-Queen',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hqb.grid(row=13,column=0)

        hkb=Label(frame3,text='♛-King',fg=lowercoin,font=('Algerian',15),bg="green",width=8,anchor= CENTER)
        hkb.grid(row=14,column=0)

        con=Label(frame3,text='control:',fg="purple",font=('Algerian',15),bg="yellow",width=8,anchor= CENTER)
        con.grid(row=16,column=0)

        con=Label(frame3,text='select-LMB\nmove-RMB',fg="purple",font=('Algerian',13),bg="yellow",width=9)
        con.grid(row=17,column=0)
        ...
        close=Button(frame3,width=7,text='BACK',font=('Algerian',15),fg='black',bg='red',command=close)
        close.grid(row=15,column=0,ipadx=4,pady=1)
